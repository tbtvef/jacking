...
g= datetime.datetime(2090,12,20)
...
def logo():
    ...
    """)
logo()
print(f""" -{ror} Decode By : {white}@spyther {white}┃  {ror}Channel : {white}@spyther  py- """) 
print(ror+"")                                                                        
print(f"  └──────────────────────────────────────────┘                ")
print(ror+"")                                                                         
import os

ID = os.getenv("ID") or os.getenv("USER_ID") or input("Enter ID - ")
print(cyan+"")
token = os.getenv("TOKEN") or os.getenv("BOT_TOKEN") or input("Enter Token - ")
os.system('clear') 

table = Table(title="𝗠  𝗘  𝗡  𝗨  ",style="blue")
table.add_column("[ror]The Tool By : 𓌹 Spyther 𓌺  ",style='green')
table.add_row("𝟭.   𝟮𝟬𝟭𝟬 - 𝟮𝟬𝟭𝟭",style='green')
table.add_row(" ",style='green')
table.add_row("𝟮.   𝟮𝟬𝟭𝟮",style='green')
table.add_row(" ",style='green')
table.add_row("𝟯.   𝟮𝟬𝟭𝟯",style='green')
table.add_row(" ",style='green')
table.add_row("𝟰.   𝟮𝟬𝟭𝟮 - 𝟮𝟬𝟭𝟯",style='green')
table.add_row(" ",style='green')
table.add_row("𝟱.   𝟮𝟬𝟭𝟰 - 𝟮𝟬𝟭𝟱",style='green')
table.add_row(" ",style='green')
table.add_row("𝟲.   𝟮𝟬𝟭𝟱 - 𝟮𝟬𝟭𝟲",style='green')
table.add_row(" ",style='green')
table.add_row("𝟳.   𝟮𝟬𝟭𝟬 - 𝟮𝟬𝟭𝟵",style='green')
table.add_row(" ",style='green')
console = Console()
console.print(table)
print(O+' '*20)
rorc = os.getenv("MENU_CHOICE") or input("𝗘𝗻𝘁𝗲𝗿 𝗖𝗵𝗼𝗶𝗰𝗲 -  ") 
os.system('clear') 
...
table = Table(title="𝗦 𝗘 𝗟 𝗘 𝗖 𝗧   𝗦 𝗣 𝗘 𝗘 𝗗",style="blue")
table.add_column("[ror] 𝗧   𝗛   𝗥   𝗘   𝗔   𝗗   𝗦 ",style='green')
table.add_row("𝟭.   𝟭𝟱                  ",style='green')
table.add_row(" ",style='green')
table.add_row("𝟮.   𝟱𝟬                  ",style='green')
table.add_row(" ",style='green')
table.add_row("𝟯.   𝟭𝟬𝟬                  ",style='green')
table.add_row(" ",style='green')
table.add_row("𝟰.   𝟭𝟱𝟬                  ",style='green')
table.add_row(" ",style='green')
console = Console()
console.print(table)
print(O+' '*20)

rorss = os.getenv("SPEED_CHOICE") or input("𝗘𝗻𝘁𝗲𝗿 𝗖𝗵𝗼𝗶𝗰𝗲 -  ") 
...
{cyan}──SPYTHER ──
{cyan} [ 𝟏 ] {white}𝐇𝐈𝐓  - {green}{hit}          
{cyan} [ 𝟐 ] {white}𝐅𝐀𝐋𝐒𝐄 - {red}{b_ig}          
{cyan} [ 𝟑 ] {white}𝐁𝐀𝐃 𝐌𝐀𝐈𝐋 - {yellow} {be}              
{cyan}───────────────────────────      	
   		""") 
...
# ==============================
# ==============================
# 👇 Final section with /start reply
# ==============================
if __name__ == "__main__":
    ...
    # --- minimal Telegram /start listener ---
                ...
                for upd in res.get("result", []):
                    ...
                    if text and text.lower().startswith("/start"):
                        requests.post(
                            ...
                            json={"chat_id": chat_id, "text": "🤖 Bot is alive and running!"},
                            timeout=10
                        )
            except Exception:
                pass
